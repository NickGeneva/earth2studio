...
class VizBackend(Protocol):
    ...
    def render(self, scene: Scene, **kwargs) -> RenderResult: ...
    def show(self, scene: Scene, **kwargs) -> Any: ...
    def save(self, scene: Scene, path: str | Path, **kwargs) -> Path: ...
    def animate(self, scene: Scene, path: str | Path, **kwargs) -> Path: ...
```
