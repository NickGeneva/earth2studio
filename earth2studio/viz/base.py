...
`AssetSourceProtocol`, and `TextureManagerProtocol` define the small contracts
downstream packages need for layers, scenes, renderer backends, external assets,
and backend-internal texture streaming.
"""
